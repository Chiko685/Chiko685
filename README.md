...
<p align="left">
  <img src="https://github-readme-stats.vercel.app/api?username=Chiko685&show_icons=true&theme=tokyonight" height="160"/>
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Chiko685&layout=compact&theme=tokyonight" height="160"/>
</p>
...
### 🔹 Turning Raw Data into Marketing Insights: SQL RFM Segmentation + Tableau
`PostgreSQL` `SQL` `Tableau`  
Customer segmentation using RFM analysis — scored 92 customers into 8 segments (Champions, Loyal, At Risk, etc.) with interactive Tableau sales dashboard.  
[View Project →](https://github.com/Chiko685/Turning-Data-into-Marketing-Insights-SQL-RFM-Segmentation-Tableau-Sales-Dashboard.git)

### 🔹 A/B Testing: Marketing Campaign & Funnel Analysis
`Tableau` `Statistics`  
Compared Campaign A vs B across full funnel metrics (CTR, CPC, CPM, Conversion Rate). Campaign B achieved 46% higher conversion rate despite smaller audience reach.  
[View Project →](https://github.com/Chiko685/A-B-Testing-Marketing-Campaign-Funnel-Analysis-Tableau-.git)

### 🔹 Advanced SQL Performance Analytics — Maven Fuzzy Factory
`SQL` `MySQL`  
Optimized traffic and conversion performance using advanced SQL — window functions, subqueries, and cohort analysis for a real e-commerce business case.  
[View Project →](https://github.com/Chiko685/Marketing-Analytics---Maven-Fuzzy-Factory.git)

### 🔹 Customer Segmentation Using K-Means Clustering
`Python` `Scikit-learn` `Matplotlib`  
Clustered customers by Age, Income, and Spending Score using K-Means. Identified 5 distinct customer groups to support targeted marketing strategies.  
[View Project →](https://github.com/Chiko685/Customer-Segmentation-using-K-Means-Clustering.git)

### 🔹 Sales Forecasting — ARIMA & SARIMAX
`Python` `ARIMA` `SARIMAX` `Statsmodels`  
Built time-series forecasting models (Naive, ARIMA, SARIMAX) to predict future sales demand with seasonal adjustments.  
[View Project →](https://github.com/Chiko685/Sales-Demand-Forecasting-Using-ARIMA-SARIMAX.git)
